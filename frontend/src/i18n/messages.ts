export const messages = {
  'zh-CN': {
    ...
    responseSearch: '搜索响应',
    responseInspectorPlaceholder: '搜索响应；输入 $ 查看 JSONPath，回车查询',
  ...
  'en-US': {
    ...
    selectVariableHint: 'Select a variable to edit',
    ...
    responseInspectorPlaceholder: 'Search response; type $ for JSONPath, Enter to query',
